...
<input type="text" name="id" placeholder="Enter Question ID">
<textarea name="ans" cols="50" rows="20" placeholder="Enter Your Answer." required>
</textarea>
...
if(isset($_POST['ok']))
{				$a=$_SESSION['usrname'];	
				if($i = mysql_query("INSERT INTO `ans_bank`(`ques_id`,`ans`,`usrname`)VALUES('".$_POST['id']."','".$_POST['ans']."','$a')"))
				{
