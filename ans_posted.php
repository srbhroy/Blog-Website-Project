...
<div>
<h1 style='color:#660066; font: italic bold 60px Georgia, serif;'>Answers posted by you</h1>
<?php		
$a=$_SESSION['usrname'];
if($k = mysql_query("SELECT `ques_topic`,`ans` FROM `ques_bank`,`ans_bank` WHERE `ans_bank`.`ques_id` = `ques_bank`.`ques_id` and `ans_bank`.`usrname`='$a'"))
{
echo
"<table id='t'>
<tr>
...
{
echo "You did'nt posted any Answers yet.";
}
echo "</table>";
?>
</div>
